 ...
 */
@Component
public class SimpleJdbcInsertExample implements CommandLineRunner {

    private static final Logger log = LoggerFactory.getLogger(SimpleJdbcInsertExample.class);
