...
/**
 * Ejemplo de como hacer una query basica, recuperamos el numero de customers de la base de datos
 * 
 */
@Component
public class BasicQueriesJdbc implements CommandLineRunner {

	// Objeto logger que nos permite imprimir en un log con mas informacion de lo
	// que haria un system.out.print
	private static final Logger log = LoggerFactory.getLogger(BasicQueriesJdbc.class);
